...
conn = psycopg2.connect(database="d86u2pacceck0q", user="kdwwsivrbhavjf", password="d3e7832a1ba7ee6055e00c9300f913227bdae6f398316babbf53f19ad2590486", host="ec2-44-208-88-195.compute-1.amazonaws.com", port="5132")
cur = conn.cursor()
